        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Card 1 */}
              <Link href="/adv_daily_transaction" className="bg-gradient-to-br from-blue-600 to-indigo-650 rounded-xl p-6 border border-slate-800 shadow-lg gradient-card-hover relative overflow-hidden block cursor-pointer hover:-translate-y-1 transition-all">
              ...
              {/* Card 2 */}
              <Link href="/adv_success_transaction" className="bg-gradient-to-br from-blue-600 to-indigo-650 rounded-xl p-6 border border-slate-800 shadow-lg gradient-card-hover relative overflow-hidden block cursor-pointer hover:-translate-y-1 transition-all">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full translate-x-8 -translate-y-8 pointer-events-none" />
              ...
              {/* Card 3 */}
              <Link href="/adv_failed_transaction" className="bg-gradient-to-br from-blue-600 to-indigo-650 rounded-xl p-6 border border-slate-800 shadow-lg gradient-card-hover relative overflow-hidden block cursor-pointer hover:-translate-y-1 transition-all">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full translate-x-8 -translate-y-8 pointer-events-none" />
              ...
              {/* Card 4 */}
              <Link href="/adv_completed_drafts" className="bg-gradient-to-br from-emerald-600 to-teal-500 rounded-xl p-6 border border-slate-800 shadow-lg gradient-card-hover relative overflow-hidden block cursor-pointer hover:-translate-y-1 transition-all">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full translate-x-8 -translate-y-8 pointer-events-none" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {/* Card 5 */}
              <div className="bg-gradient-to-br from-blue-600 to-indigo-650 rounded-xl p-6 border border-slate-800 shadow-lg relative overflow-hidden block">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full translate-x-8 -translate-y-8 pointer-events-none" />
              ...
              {/* Card 6 */}
              <div className="bg-gradient-to-br from-pink-600 to-rose-500 rounded-xl p-6 border border-slate-800 shadow-lg relative overflow-hidden block">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full translate-x-8 -translate-y-8 pointer-events-none" />
              ...
              {/* Card 7 */}
              <Link href="/adv_completed_drafts" className="bg-gradient-to-br from-blue-600 to-indigo-650 rounded-xl p-6 border border-slate-800 shadow-lg gradient-card-hover relative overflow-hidden block cursor-pointer hover:-translate-y-1 transition-all">
                <div className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full translate-x-8 -translate-y-8 pointer-events-none" />
